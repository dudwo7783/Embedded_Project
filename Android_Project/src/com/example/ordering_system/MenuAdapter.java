...
public class MenuAdapter extends BaseAdapter {
    ...
    private ArrayList<MenuList> listViewItemList = new ArrayList<MenuList>() ;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        MenuList listViewItem = listViewItemList.get(position);
    ...
    public void addItem(String tn, String menu, int time, TimerTask job) {
